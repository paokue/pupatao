...
export const STRINGS = {
  ...
  'auth.alreadyHaveAccount':  { lo: 'ມີບັນຊີແລ້ວ?',           en: 'Already have an account?' },
  'auth.forgotPassword':      { lo: 'ລືມລະຫັດຜ່ານ? ຕິດຕໍ່ແອັດມິນ', en: 'Forgot password? Contact admin' },
  'auth.anonymous':           { lo: 'ບໍ່ມີຊື່',              en: 'Anonymous' },
  'auth.signInOrRegister':    { lo: 'ເຂົ້າສູ່ລະບົບ ຫຼື ລົງທະບຽນ', en: 'Sign in or register' },
  'auth.signInToUseRealWallet': { lo: 'ເຂົ້າສູ່ລະບົບເພື່ອໃຊ້ກະເປົາຈິງ.', en: 'Sign in to use your real wallet.' },
  'auth.registerHint':        { lo: 'ຕ້ອງການແຕ່ເບີໂທແລະລະຫັດຜ່ານ. ທ່ານສາມາດປ້ອນຊື່ແລະໂປຣໄຟລ໌ໃນພາຍຫຼັງ.', en: 'Only phone number and password are required. You can fill in your name and profile later.' },
  ...
  'wallet.transferComingSoon': { lo: 'ການໂອນກຳລັງຈະມາໄວໆນີ້.', en: 'Transfer is coming soon.' },
  ...
  'wallet.noTx.deposit':    { lo: 'ຍັງບໍ່ມີລາຍການຝາກ.',     en: 'No deposit transactions yet.' },
  'wallet.noTx.withdraw':   { lo: 'ຍັງບໍ່ມີລາຍການຖອນ.',     en: 'No withdraw transactions yet.' },
  'wallet.noTx.transfer':   { lo: 'ຍັງບໍ່ມີລາຍການໂອນ.',     en: 'No transfer transactions yet.' },
  'wallet.viewSlip':        { lo: 'ເບິ່ງໃບໂອນ',             en: 'View slip' },
  'wallet.errEnterAmount':  { lo: 'ໃສ່ຈຳນວນທີ່ຖືກຕ້ອງ.',    en: 'Enter a valid amount.' },
  'wallet.errMin':          { lo: 'ຕ່ຳສຸດ {amount} ₭.',     en: 'Minimum {amount} ₭.' },
  'wallet.errMax':          { lo: 'ສູງສຸດ {amount} ₭.',     en: 'Maximum {amount} ₭.' },
  'wallet.errExceedsBalance': { lo: 'ການຖອນເກີນຍອດເງິນຂອງທ່ານ.', en: 'Withdraw exceeds your available balance.' },
  ...
  // ─── Deposit modal ───────────────────────────────────────────────────
  'deposit.step1':          { lo: 'ຂັ້ນຕອນ 1 · ສະແກນເພື່ອຈ່າຍ', en: 'STEP 1 · SCAN TO PAY' },
  'deposit.step2':          { lo: 'ຂັ້ນຕອນ 2 · ອັບໂຫຼດໃບໂອນ',  en: 'STEP 2 · UPLOAD SLIP' },
  'deposit.qrInstruction':  { lo: 'ສະແກນ QR ດ້ວຍແອັບທະນາຄານ ຫຼື ກະເປົາເງິນເພື່ອໂອນຍອດຂ້າງເທິງ. ເມື່ອໂອນແລ້ວ ກົດ "ຖັດໄປ" ເພື່ອອັບໂຫຼດໃບໂອນ.', en: 'Scan the QR code with your bank or e-wallet app to transfer the amount above. Once payment is sent, tap Next to upload your payment slip.' },
  'deposit.uploadInstruction': { lo: 'ອັບໂຫຼດຮູບໃບໂອນຂອງທ່ານ. ການຝາກຈະຖືກກວດສອບໂດຍແອັດມິນ ແລະ ເຕີມຍອດເງິນເມື່ອອະນຸມັດ.', en: 'Upload a screenshot of your payment slip. Your deposit will be reviewed by an admin and credited once verified.' },
  'deposit.example':        { lo: 'ຕົວຢ່າງ',                en: 'EXAMPLE' },
  'deposit.tapForFull':     { lo: 'ກົດເພື່ອເບິ່ງເຕັມຈໍ',     en: 'Tap to view full screen' },
  'deposit.tapToChooseSlip':{ lo: 'ກົດເພື່ອເລືອກໃບໂອນ',      en: 'Tap below to choose your slip' },
  'deposit.fileTypes':      { lo: 'JPG / PNG / WebP / PDF · ສູງສຸດ 8MB', en: 'JPG / PNG / WebP / PDF · max 8MB' },
  ...
  'deposit.submittedDesc':  { lo: 'ກຳລັງລໍຖ້າການຢືນຢັນຈາກແອັດມິນ. ທ່ານຈະໄດ້ຮັບແຈ້ງເຕືອນເມື່ອອະນຸມັດ.', en: 'Awaiting admin verification. You will be notified once approved.' },
  ...
  'deposit.aria.viewQr':    { lo: 'ເບິ່ງ QR ເຕັມຈໍ',         en: 'View QR code full screen' },
  'deposit.aria.viewExample': { lo: 'ເບິ່ງຕົວຢ່າງໃບໂອນ',     en: 'View example payment slip full screen' },
  ...
  'withdraw.qrInstruction':   { lo: 'ອັບໂຫຼດ QR ຂອງບັນຊີທະນາຄານທີ່ຈະຮັບເງິນຖອນ. ພວກເຮົາຈະບັນທຶກໄວ້ ບໍ່ຕ້ອງອັບໂຫຼດໃໝ່ຄັ້ງໜ້າ.', en: "Upload the QR code of the bank account that should receive your withdrawal. We'll keep it on file so you don't need to upload it again next time." },
  'withdraw.confirmInstruction': { lo: 'ພວກເຮົາຈະສົ່ງເງິນຖອນໄປບັນຊີຂ້າງລຸ່ມເມື່ອແອັດມິນຢືນຢັນ.', en: "We'll send the withdrawal to the account below once an admin verifies your request." },
  'withdraw.tapToUpload':     { lo: 'ກົດເພື່ອອັບໂຫຼດ QR ທະນາຄານ', en: 'Tap below to upload your bank QR' },
  'withdraw.fileTypes':       { lo: 'JPG / PNG / WebP · ສູງສຸດ 5MB', en: 'JPG / PNG / WebP · max 5MB' },
  ...
  'withdraw.submittedDesc':   { lo: 'ກຳລັງລໍຖ້າການຢືນຢັນຈາກແອັດມິນ. ເງິນຈະຖືກສົ່ງໄປ QR ທະນາຄານຂອງທ່ານເມື່ອອະນຸມັດ.', en: 'Awaiting admin verification. Funds will be sent to your bank QR once approved.' },
  'withdraw.aria.close':      { lo: 'ປິດ',                  en: 'Close withdraw' },
  'withdraw.aria.viewQr':     { lo: 'ເບິ່ງ QR ເຕັມຈໍ',       en: 'View bank QR full screen' },
  ...
  'profile.phoneReadonly':    { lo: 'ເບີໂທລະສັບ (ບໍ່ສາມາດປ່ຽນໄດ້)', en: 'Phone number (cannot be changed)' },
  'profile.personalInfo':     { lo: 'ຂໍ້ມູນສ່ວນຕົວ',         en: 'Personal information' },
  'profile.unnamed':          { lo: 'ຜູ້ຫຼິ້ນບໍ່ມີຊື່',      en: 'Unnamed player' },
  'profile.memberSince':      { lo: 'ສະມາຊິກຕັ້ງແຕ່ {date}', en: 'Member since {date}' },
  'profile.bankQr':           { lo: 'QR ທະນາຄານ',            en: 'Bank QR' },
  'profile.bankQrDesc':       { lo: 'ການຖອນເງິນຈະຖືກສົ່ງໄປບັນຊີໃນ QR ນີ້. ທ່ານສາມາດປ່ຽນໄດ້ທຸກເມື່ອ — ຄຳຂໍຖອນທີ່ກຳລັງລໍຖ້າຈະຍັງໃຊ້ QR ທີ່ສົ່ງໄປ.', en: 'Withdrawals are sent to the bank account encoded in this QR. You can replace it any time — pending withdrawals keep the QR they were submitted with.' },
  'profile.noBankYet':        { lo: 'ຍັງບໍ່ໄດ້ອັບໂຫຼດ QR ທະນາຄານ', en: 'No bank QR uploaded yet' },
  ...
  'profile.bankQrUpdatedDesc':{ lo: 'ການຖອນຕໍ່ໄປຈະຖືກສົ່ງໄປບັນຊີນີ້.', en: 'Future withdrawals will go to this account.' },
  'profile.profileUpdated':   { lo: 'ປ່ຽນຂໍ້ມູນແລ້ວ',         en: 'Profile updated' },
  'profile.profileUpdatedDesc': { lo: 'ການປ່ຽນແປງຂອງທ່ານຖືກບັນທຶກແລ້ວ.', en: 'Your changes have been saved.' },
  'profile.current':          { lo: 'ປັດຈຸບັນ',              en: 'CURRENT' },
  'profile.notSet':           { lo: 'ຍັງບໍ່ໄດ້ຕັ້ງ',         en: 'NOT SET' },
  'profile.language':         { lo: 'ພາສາ',                  en: 'Language' },
  'profile.languageDesc':     { lo: 'ປ່ຽນພາສາທີ່ສະແດງໃນແອັບ.', en: 'Switch the language used across the app.' },

  // ─── Game (home page) ────────────────────────────────────────────────
  'game.modeSelf':            { lo: '🎲 ຫຼິ້ນຄົນດຽວ',         en: '🎲 Self Play' },
  'game.modeLive':            { lo: '🔴 ຖ່າຍທອດສົດ',          en: '🔴 Live' },
  'game.toggleToRandom':      { lo: 'ປ່ຽນໄປໂໝດ ສຸ່ມ',         en: 'Switch to RANDOM mode' },
  'game.toggleToLive':        { lo: 'ປ່ຽນໄປໂໝດ ຖ່າຍທອດສົດ',   en: 'Switch to LIVE (host) mode' },
  ...
  'game.low':                 { lo: 'ຕ່ຳ',                     en: 'LOW' },
  'game.middle':              { lo: 'ກາງ',                     en: 'MIDDLE' },
  'game.high':                { lo: 'ສູງ',                     en: 'HIGH' },
  'game.pays':                { lo: 'ຈ່າຍ {x}x',               en: 'Pays {x}x' },
  'game.tapAdjacent':         { lo: 'ກົດເຊວ, ແລ້ວກົດເຊວ ຕິດກັນ ເພື່ອວາງເດີມພັນ PAIR (×6). ກົດເຊວດຽວສອງຄັ້ງເພື່ອວາງຄັ້ງດຽວ.', en: 'Tap a cell, then tap an adjacent cell for a PAIR bet (×6). Tap same cell twice for a single.' },
  ...
  'game.demoBalance':         { lo: 'ຣີເຊັດກະເປົາທົດລອງເປັນ {amount} ₭', en: 'Reset demo balance to {amount} ₭' },
  ...
  'menu.playHistoryDesc':     { lo: 'ເບິ່ງປະຫວັດເກມຂອງທ່ານ', en: 'View your game records' },
  ...
  // ─── History page ───────────────────────────────────────────────────
  'history.title':              { lo: 'ປະຫວັດການຫຼິ້ນ (ກະເປົາຈິງ)', en: 'Play History (Real)' },
  'history.lifetimeStats':      { lo: 'ສະຖິຕິລວມ · ກະເປົາຈິງ',  en: 'LIFETIME STATS · REAL WALLET' },
  ...
  'transfer.codeHint':           { lo: 'ສົ່ງລະຫັດໃຫ້ຜູ້ຮັບແບບສ່ວນຕົວ. ລະບົບຈະບໍ່ສະແດງລະຫັດກັບຜູ້ຮັບ.', en: 'Share this code with the recipient privately — the system never reveals it on their side.' },
  'transfer.shareCodeWarning':   { lo: '⚠️ ບັນທຶກລະຫັດໄວ້ກ່ອນຢືນຢັນ — ຫຼັງສົ່ງແລ້ວ ບໍ່ສາມາດເບິ່ງໄດ້ອີກ.', en: '⚠️ Save this code before confirming — it is not shown again after submit.' },
  'transfer.confirmCta':         { lo: 'ຢືນຢັນການໂອນ',             en: 'CONFIRM TRANSFER' },
  'transfer.confirmGeneralDesc': { lo: 'ຢືນຢັນເພື່ອຫັກເງິນຈາກກະເປົາທ່ານ ແລະ ສົ່ງໄປໃຫ້ຜູ້ຮັບທັນທີ.', en: 'Confirm to debit your wallet and credit the recipient immediately.' },
  'transfer.confirmLockedDesc':  { lo: 'ເງິນຈະຖືກຫັກທັນທີ. ຜູ້ຮັບຕ້ອງປ້ອນລະຫັດຈຶ່ງຈະໄດ້ຮັບເງິນ. ທ່ານສາມາດຍົກເລີກໄດ້ກ່ອນຮັບ.', en: "Funds leave your wallet immediately. The recipient must enter the code to receive — you can cancel before they do." },
  'transfer.errPhone':           { lo: 'ປ້ອນເບີໂທລະສັບຜູ້ຮັບ.',    en: 'Recipient phone is required.' },
  'transfer.errSelf':            { lo: 'ບໍ່ສາມາດໂອນຫາຕົວເອງ.',      en: "You can't transfer to yourself." },
  'transfer.errLookupFirst':     { lo: 'ກວດສອບເບີໂທຂອງຜູ້ຮັບກ່ອນ.', en: 'Look up the recipient first.' },
  'transfer.errInactive':        { lo: 'ບັນຊີຜູ້ຮັບບໍ່ໄດ້ໃຊ້ງານ.',  en: "Recipient's account is not active." },
  'transfer.errNotFound':        { lo: 'ບໍ່ພົບເບີໂທນີ້.',           en: 'Phone number not found.' },
  'transfer.errCode':            { lo: 'ລະຫັດຕ້ອງເປັນ 6 ຕົວເລກ.',   en: 'Code must be 6 digits.' },
  'transfer.submitted':          { lo: 'ສົ່ງການໂອນແລ້ວ',           en: 'Transfer sent' },
  'transfer.submittedDesc':      { lo: 'ການໂອນຂອງທ່ານໄດ້ຖືກສົ່ງເຖິງຜູ້ຮັບ.', en: 'Your transfer has been delivered.' },
  ...
  'transfer.claimDesc':          { lo: 'ປ້ອນລະຫັດ 6 ຕົວເລກທີ່ {sender} ສົ່ງມາໃຫ້.', en: 'Enter the 6-digit code that {sender} shared with you.' },
  'transfer.claimCta':           { lo: 'ຮັບເງິນ',                  en: 'CLAIM' },
  'transfer.claimed':            { lo: 'ຮັບການໂອນແລ້ວ',            en: 'Transfer claimed' },
  'transfer.claimedDesc':        { lo: 'ເງິນຖືກເພີ່ມເຂົ້າກະເປົາຂອງທ່ານແລ້ວ.', en: 'The funds have been credited to your wallet.' },
  'transfer.cancelConfirmTitle': { lo: 'ຍົກເລີກການໂອນ?',           en: 'Cancel this transfer?' },
  'transfer.cancelConfirmDesc':  { lo: 'ເງິນ {amount} ₭ ຈະຖືກສົ່ງຄືນເຂົ້າກະເປົາຂອງທ່ານທັນທີ.', en: '{amount} ₭ will be refunded to your wallet immediately.' },
  'transfer.cancelled':          { lo: 'ຍົກເລີກການໂອນແລ້ວ',         en: 'Transfer cancelled' },
  'transfer.cancelledDesc':      { lo: 'ເງິນຖືກສົ່ງຄືນເຂົ້າກະເປົາຂອງທ່ານ.', en: 'The funds have been refunded to your wallet.' },
  'transfer.noPendingReceived':  { lo: 'ບໍ່ມີການໂອນລໍຮັບ.',         en: 'No transfers waiting for you.' },
} as const
